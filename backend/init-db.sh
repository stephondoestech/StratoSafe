...
PGPASSWORD=${DB_PASSWORD} psql -h ${DB_HOST} -p ${DB_PORT} -U ${DB_USERNAME} -d ${DB_DATABASE} -c "ALTER TABLE \"user\" ADD COLUMN IF NOT EXISTS \"themePreference\" varchar DEFAULT 'light';"
